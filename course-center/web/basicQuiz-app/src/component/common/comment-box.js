...
import { Button, Col, Icon, Popconfirm, Divider } from 'antd'
import moment from 'moment'
import { withRouter } from 'react-router-dom'
import { connect } from 'react-redux'
import { TwsReactMarkdownPreview, TwsReactMarkdownEditor } from 'tws-antd'
import * as suggestionActions from '../../actions/comment'
...
class CommentBox extends Component {
  ...
  showEditInput (id, suggestionContent) {
    ...
    if (id !== currentEditCommentId) {
      ...
      this.props.modifyComment(id, content, assignmentId, quizId, studentId, isTutor)
  ...
  deleteComment (id) {
    this.props.deleteComment(id, this.props.assignmentId, this.props.quizId, this.props.studentId, this.props.isTutor)
  }
...
const mapDispatchToProps = dispatch => ({
  ...
  submitSectionSuggestion: (toUserId, assignmentId, quizId, studentId, content, parentId) => dispatch(suggestionActions.submitSuggestion(toUserId, assignmentId, quizId, studentId, content, parentId)),
  submitReplySuggestion: (toUserId, assignmentId, quizId, content, parentId, isTutor) => dispatch(suggestionActions.submitReploySuggestion(toUserId, assignmentId, quizId, content, parentId, isTutor)),
