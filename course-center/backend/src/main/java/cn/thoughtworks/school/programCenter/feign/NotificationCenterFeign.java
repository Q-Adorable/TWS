...
public interface NotificationCenterFeign {
    ...
    ResponseEntity updateUnReadToReadById(@PathVariable("notificationId") Long notificationId, @RequestParam("status") String status);

    @PostMapping("api/notifications")
    List addNotification(@RequestBody Map map);
}
